                                    ...
                                    <div class="col-lg-3">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                >
                                                    <option></option>
                                                    <option value='지학사' ${param.joinRoot eq '지학사' ? 'selected' : ''}>정기구독</option>
                                                    <option value='네이버' ${param.joinRoot eq '네이버' ? 'selected' : ''}>책 내용 관련</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-6">
                   ...
                   <%@ include file="/WEB-INF/views/common/SelectPaging.jsp" %>
                        ...
                        <div class="card-body pt-0 table-responsive">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <a href="/book-review/book-review-registration-form" class="btn btn-m btn-dark">
                                        순서변경
                                    </a>
                                </div>
                                ...
                                <div>
                                    <a href="/book-review/frequent-question-form" class="btn btn-m" style=" color: #fff; background-color: #343a40;">
                                        등록
                                    </a>
                                </div>
                            </div>
