                                ...
                                <div class="row g-8">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <label class="fs-6 form-label fw-bolder text-dark">언론보도 인트로 노출여부</label>
                                                <select
                                                        id="isPressIntro"
                                                        name="isPressIntro"
                                                        class="form-select form-select-solid unselect-form"
                                                ...
                                                >
                                                    <option>전체</option>
                                                    <option value='Y' ${param.isPressIntro eq 'Y' ? 'selected' : ''}>Y</option>
                                                    <option value='N' ${param.isPressIntro eq 'N' ? 'selected' : ''}>N</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="col-lg-2 d-flex justify-content-end mt-8"  data-kt-customer-table-toolbar="base">
                                        <div>
                                            <a href="/book-trigger/book-trigger" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
                        ...
                        <div class="card-body pt-0 table-responsive">
                            ...
                            <table class="table table-row-bordered gy-5" id="faqCommonTable">
                                ...
                                <tr class="fw-semibold fs-6 text-muted">
                                    ...
                                    <th class="min-w-30px">언론보도<br/>인트로 노출여부</th>
                                ...
                                <c:if test="${not empty list}">
                                    <c:forEach items="${list}" var="list" varStatus="status">
                                        <tr>
                                            ...
                                            <td class="text-hover-warning hoverable ${list.isPressIntro eq 'Y' ? 'text-danger' : 'text-primary'} vertical_center"
                                                data-uid="${list.uid}"
                                                name="userPhoneNumber"
                                                onclick="openUserForm(this)">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/book-trigger/book-trigger-reg-form" class="btn btn-m" style=" color: #fff; background-color: #343a40;">
                                        등록
                                    </a>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function fetchUserList(page) {
        ...
        const isPressIntro = document.getElementById('isPressIntro').value;
        ...
        if (isPressIntro != null || isPressIntro !== undefined) {
            queryParams += '&isPressIntro=' + isPressIntro;
        }
        ...
        location.href = '/book-trigger/book-trigger' + queryParams;
    }
    ...
    function openUserForm(element) {
        ...
        const url = '/book-trigger/book-trigger/' + uid + queryParams;
