                                                    ...
                                                    <div class="row mb-8" id="onlineStoreLine${status.index + 1}">
                                                        <div class="col-lg-12 row">
                                                            ...
                                                            <div class="col-lg-11 row">
                                                                ...
                                                                <div class="col-lg-5 row fv-row flex-column">
                                                                    <input type="text" class="form-control       autocomplete="off" onlineInput${status.index}" placeholder="온라인 서점 URL 입력" data-idx="${status.index}" name="onlineBookStore" value="${online.storeUrl}" oninput="validateOnlineStore()" />
                                                                    <div class="base-input__error"></div>
                                                                </div>
                                                                <div class="col-lg-2 d-flex justify-content-center align-items-center">
...
<script type="text/javascript">
    ...
    async function showIntro() {
        ...
        if (isOpen === 'N') {
            Swal.fire({
                ...
                // const showIsIntroNError = document.getElementById('showIsIntroNError');
                // if (showIsIntroNError.style.display === 'block') {
                //     showIsIntroNError.style.display = 'none';
                // }
            })
        } else {
    ...
    async function isPressCheckStep(element) {
        ...
        try {
            const response = await fetch ('/api/v1/book-trigger-registration/press-intro/BOOK-TRIGGER?uid=', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
    ...
    async function postApi() {
        ...
        let awardList = [];
        if (isPressIntro === 'Y') {
            pressTitleList = getAllPressIntroTitle();
                ...
                <div class="col-lg-12 row">
                    ...
                    <div class="col-lg-11 row">
                        ...
                        <div class="col-lg-5 row flex-column">
                            <input type="text" class="form-control onlineInput` + itemCnt + `" data-idx="`+ itemCnt + `" name="onlineBookStore" placeholder="온라인 서점 URL 입력" oninput="validateOnlineStore()" />
                           <div class="base-input__error"></div>
                        </div>
                       <div class="col-lg-2 d-flex justify-content-center align-items-center">
