                        ...
                        <form class="form">
                                ...
                                <div class="row g-8">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        >
                                            ...
                                            <option value='SERIES_CODE' ${param.searchKey eq 'SERIES_CODE' ? 'selected' : ''}>시리즈코드</option>
                                            <option value='REFERENCE_BOOK_TITLE'   ${param.searchKey eq 'REFERENCE_BOOK_TITLE' ? 'selected' : ''}>참고서명</option>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/reference-book/reference-book-list" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
                        ...
                        <div class="card-body pt-0 table-responsive">
                            ...
                            <table class="table table-row-bordered gy-5" id="faqCommonTable">
                                ...
                                <tr class="fw-semibold fs-6 text-muted">
                                    ...
                                    <th class="min-w-30px">시리즈코드</th>
                                    <th class="min-w-20px">학급</th>
                                    <th class="min-w-20px">과목</th>
                                    <th class="min-w-120px">참고서명</th>
                                    ...
                                    <c:forEach items="${list}" var="list" varStatus="status">
                                        <tr>
                                            ...
                                            <td class="text-hover-warning hoverable vertical_center"
                                                ...
                                                onclick="openUserForm(this)">
                                                <img src="${uploadUrl}${list.fileInfo.filePath}" style="width: 54px; height: 70px; margin: 10px"/>
                                            ...
                                            <td class="text-hover-warning hoverable vertical_center ${list.isOpen eq 'Y' ? 'text-danger' : 'text-primary'}"
                                                data-uid="${list.uid}"
                                                name="userPhoneNumber"
                                                onclick="openUserForm(this)">
                                                <c:out value="${list.isOpen}"/>
                                            </td>
                                            <td class="text-hover-warning hoverable vertical_center ${list.isIntro eq 'Y' ? 'text-danger' : 'text-primary'}"
                                                data-uid="${list.uid}"
                                                name="userPhoneNumber"
                                                onclick="openUserForm(this)">
                                            ...
                                            <td class="text-hover-warning hoverable vertical_center"
                                                ...
                                                name="userPhoneNumber"
                                                onclick="openUserForm(this)">
                                                <c:out value="${list.adminNamePlusDepartment}"/>
                                            </td>
                                            <td class="text-hover-warning hoverable vertical_center"
                                                data-uid="${list.uid}"
                                                name="userPhoneNumber"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/reference-book/reference-book-reg-form" class="btn btn-m" style=" color: #fff; background-color: #343a40;">
                                        등록
                                    </a>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function fetchUserList(page) {
        ...
        location.href = '/reference-book/reference-book-list' + queryParams;
    }
    ...
    function openUserForm(element) {
        ...
        const url = '/reference-book/reference-book/' + uid + queryParams;
