                    ...
                    <div class="card mb-7">
                            <div class="card-body">
                                ...
                                <div class="row g-8">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        >
                                            <option></option>
                                            <option value='로그인' ${param.type eq '로그인' ? 'selected' : ''}>로그인</option>
                                            <option value='로그아웃' ${param.type eq '로그아웃' ? 'selected' : ''}>로그아웃</option>
                                            <option value='비밀번호 오류'   ${param.type eq '비밀번호 오류' ? 'selected' : ''}>비밀번호 오류</option>
                                            <option value='비밀번호 5회 오류' ${param.type eq '비밀번호 5회 오류' ? 'selected' : ''}>비밀번호 5회 오류</option>
                                        </select>
                                    </div>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/log/login-log" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
