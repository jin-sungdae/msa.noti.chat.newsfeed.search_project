                        ...
                        <form class="form">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/log/error-detection" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
                        ...
                        <div class="card-body pt-0 table-responsive">
                            ...
                            <table class="table table-row-bordered gy-5" id="faqCommonTable">
                                ...
                                <tr class="fw-semibold fs-6 text-muted">
                                    ...
                                    <th class="min-w-70px">User IP</th>
                                    <th class="min-w-60px">User ID</th>
                                </tr>
                                <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
...
<script type="text/javascript">
    ...
    function fetchUserList(page) {
        ...
        location.href = '/log/error-detection' + queryParams;
    }
    ...
    function openUserForm(element) {
        ...
        const url = '/log/error-detection-form?errorLogIndex=' + id;
