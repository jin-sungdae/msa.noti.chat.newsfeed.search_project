 ...
 */
 /*
 document ready 에서 nestable 하지 않고, call 할 때 세팅하도록 바꿈.
 원본은 nestable.js_org
 2015 08 24 hjkim
 */
if(typeof global == 'undefiend' || global == null)
 	global = {};
global.setNestable = function (){
	global.callAddon(global.initNestable);
};
global.callAddon = (function(addon) {
...
global.initNestable = (function($, UI) {
    ...
    UI.component('nestable', {
        ...
        init: function()
        {
            ...
            /*
            * table 에서 쓸 때  line no 111 ~ 116
            * 2015 08 20 hjkim
            */
            if(this.options.listNodeName == 'table.p_nestable'){
            	if(this.options.itemNodeName == 'tr'){
            		colspan = $(this.element).find('tr:eq(0)').children('td').length;
            	}
            	this.placeEl = $('<tr><td colspan="'+colspan+'" style="border-bottom:1px solid black;height:42px;"></td></tr>');
            }
        ...
        dragStart: function(e) {
            ...
            /*
             * 2016 09 27 아래 주석 원본코드 hjkim
             * */
            if(this.options.listNodeName.indexOf('table') != -1){
            	this.dragEl = $(document.createElement('table')).addClass(this.options.listClass + ' ' + this.options.dragClass);
            }else{
            ...
            //this.dragEl.find('td').css('padding', '0 9px');
        ...
        dragMove: function(e) {
            ...
            //start
            //if(this.pointEl.get(0).tagName == 'TD')
            	//this.pointEl = this.pointEl.parent('tr');
            //end
