                            ...
                            <div class="card-body">
                                <div class="row mb-8">
                                    <div class="col-lg-12 row">
                                        ...
                                        <div class="fv-row fv-plugins-icon-container col-lg-10 flex-column" id="corrigerndum">
                                            <!-- 파일 업로드 섹션 -->
                                            <jsp:include page="/FileFormINC" flush="false">
                                                <jsp:param name="isImage" value="false" />
                                                <jsp:param name="hasOrder" value="false" />
                                            ...
                                            <span class="base-input__error" id="corrigerndumError"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-lg-12 row">
                                        <div class="col-lg-2  d-flex align-items-start justify-content-center">
                                            <label class="col-lg-10 form-label fw-bolder text-dark pt-3 required-check">교과서 소개</label>
                                        </div>
                                        <div class="col-lg-10">
                                            <div class="fr-element fr-view scroll-froala" style=" padding: 16px; border-radius:20px 20px 20px 20px ; background-clip: padding-box; border: 1px solid #E4E6EF">
                                                ${list.textBookDetailList[0].detailContent}
                                            </div>
                                ...
                                <div class="row mb-8">
                                    <div class="col-lg-12 row">
                                        <div class="col-lg-2  d-flex align-items-start justify-content-center" id="textDetail1">
                                            ...
                                            <label class="col-lg-10 form-label fw-bolder text-dark pt-3 textDetail" style="display: ${not empty list ? '' : 'none'}">
                                                <c:if test="${list.textBookDetailList[1].isUse eq 'N'}">
                                                    지도서 소개
                                                </c:if>
                                                <c:if test="${list.textBookDetailList[1].isUse eq 'Y'}">
                                                    ${list.textBookDetailList[1].detailTitle}
                                                </c:if>
                                            </label>
                                            <div class="w-100">
                                                <input
                                                        ...
                                                        id="detailTitle1"
                                                        name="detailTitle1"
                                                        class="form-control ${list.textBookDetailList[1].isUse eq 'Y' ? '' : 'form-control-solid'} textModifyDetail"
                                                        placeholder="지도서 소개"
                                                        maxlength="12"
                                                        minlength="2"
                                                        <c:if test="${list.textBookDetailList[1].detailTitle eq ''}">
                                                ...
                                                ${list.textBookDetailList[1].isUse eq 'Y' ? '' : 'disabled'}
                                                        oninput="setPlaceholderIfEmpty(this, '탭 명칭 입력')"
                                                />
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row mb-4">
                                                <div class="col-lg-10 row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="col-lg-3 pt-3 ${list.textBookDetailList[1].isUse eq 'Y' ? 'text-danger' : 'text-primary'}">
                                                            <c:out value="${list.textBookDetailList[1].isUse }"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12" id="textBookDetailFroalaEditor1" style="display: ${list.textBookDetailList[1].isUse eq 'Y' ? 'block' : 'none'}">
                                                    ...
                                                    <div class="fr-element fr-view scroll-froala" style="display: ${empty list ? 'none' : ''}; padding: 16px; border-radius:20px 20px 20px 20px ; background-clip: padding-box; border: 1px solid #E4E6EF">
                                                        ${list.textBookDetailList[1].detailContent}
                                                    </div>
                                ...
                                <div class="row mb-8">
                                    <div class="col-lg-12 row">
                                        <div class="col-lg-2  d-flex align-items-start justify-content-center" id="textDetail2">
                                            <div class="col-lg-1"></div>
                                            <label class="col-lg-10 form-label fw-bolder text-dark pt-3 textDetail" style="display: ${not empty list ? '' : 'none'}">
                                                <c:if test="${list.textBookDetailList[2].isUse eq 'N'}">
                                                    집필진 소개
                                                </c:if>
                                                <c:if test="${list.textBookDetailList[2].isUse eq 'Y'}">
                                                    ${list.textBookDetailList[2].detailTitle}
                                                </c:if>
                                            </label>
                                            <div class="w-100">
                                                <input
                                                        ...
                                                        id="detailTitle2"
                                                        name="detailTitle2"
                                                        class="form-control ${list.textBookDetailList[2].isUse eq 'Y' ? '' : 'form-control-solid'} textModifyDetail"
                                                        placeholder="집필진 소개"
                                                        minlength="2"
                                                        maxlength="12"
                                                        <c:if test="${list.textBookDetailList[2].detailTitle eq ''}">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row mb-4">
                                                <div class="col-lg-10 row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="col-lg-3 pt-3 ${list.textBookDetailList[2].isUse eq 'Y' ? 'text-danger' : 'text-primary'}">
                                                            <c:out value="${list.textBookDetailList[2].isUse }"/>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" id="textBookDetailFroalaEditor2" style="display: ${list.textBookDetailList[2].isUse eq 'Y' ? 'block' : 'none'}">
                                                    ...
                                                    <div class="fr-element fr-view scroll-froala" style="display: ${empty list ? 'none' : ''};  padding: 16px; border-radius:20px 20px 20px 20px ; background-clip: padding-box; border: 1px solid #E4E6EF">
                                                        ${list.textBookDetailList[2].detailContent}
                                                    </div>
                                ...
                                <div class="row mb-8">
                                    <div class="col-lg-12 row">
                                        <div class="col-lg-2  d-flex align-items-start justify-content-center" id="textDetail3">
                                            <div class="col-lg-1"></div>
                                            <label class="col-lg-10 form-label fw-bolder text-dark pt-3 textDetail" style="display: ${not empty list ? '' : 'none'}">
                                                <c:if test="${list.textBookDetailList[3].isUse eq 'N'}">
                                                    탭 추가
                                                </c:if>
                                                <c:if test="${list.textBookDetailList[3].isUse eq 'Y'}">
                                                    ${list.textBookDetailList[3].detailTitle}
                                                </c:if>
                                            </label>
                                            <div class="w-100">
                                                <input
                                                        ...
                                                        id="detailTitle3"
                                                        name="detailTitle3"
                                                        class="form-control ${list.textBookDetailList[3].isUse eq 'Y' ? '' : 'form-control-solid'} textModifyDetail"
                                                        placeholder="탭 추가"
                                                        minlength="2"
                                                        maxlength="12"
                                                        <c:if test="${list.textBookDetailList[3].detailTitle eq ''}">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row mb-4">
                                                <div class="col-lg-10 row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="col-lg-3 pt-3 ${list.textBookDetailList[3].isUse eq 'Y' ? 'text-danger' : 'text-primary'}">
                                                            <c:out value="${list.textBookDetailList[3].isUse }"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12" id="textBookDetailFroalaEditor3" style="display: ${list.textBookDetailList[3].isUse eq 'Y' ? 'block' : 'none'}">
                                                    ...
                                                    <div class="fr-element fr-view scroll-froala" style="display: ${empty list ? 'none' : ''};  padding: 16px; border-radius:20px 20px 20px 20px ; background-clip: padding-box; border: 1px solid #E4E6EF">
                                                        ${list.textBookDetailList[3].detailContent}
                                                    </div>
                                ...
                                <div class="row" id="modifyButton">
                                    ...
                                    <div  class="col-9 d-flex justify-content-end">
                                        <button
                                                ...
                                                onclick="deleteTextBook(this)">
                                            삭제
                                        </button>
                                        <a type="button" class="btn btn-light-warning" style="background-color: #ffcd39; color: #181C32" href="/textbook/textbook-mod-form?uid=${list.uid}">
                                            수정
                                        </a>
                                    </div>
                                </div>
