                            ...
                            <div class="card mb-5 mb-xl-10">
                                ...
                                <div class="card-body">
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            ...
                                            <div class="col-lg-4 row">
                                                ...
                                                <div id="selectUserType" class="col-lg-8" style="display: none;">
                                                    <select
                                                    ...
                                                    >
                                                        <option value="3002" ${data.user.userType eq '학생' ? 'selected' : ''}>학생</option>
                                                        <option value="3003" ${data.user.userType eq '선생님' ? 'selected' : ''}>선생님</option>
                                                        <option value="3004" ${data.user.userType eq '학부모' ? 'selected' : ''}>학부모</option>
                                                        <option value="3005" ${data.user.userType eq '일반' ? 'selected' : ''}>일반</option>
                                                        <option value="3006" ${data.user.userType eq '학원강사' ? 'selected' : ''}>학원강사</option>
                                                        <option value="2001" ${data.user.userType eq '관리자' ? 'selected' : ''}>관리자</option>
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                <label class="col-lg-10 form-label fw-bolder text-dark pt-3 required">질문</label>
                                            </div>
                                            <div class="col-lg-8">
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                <label class="col-lg-11 form-label fw-bolder text-dark pt-3 required">답변</label>
                                            </div>
                                            <div class="col-lg-11">
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                                ...
                                                <div class="col-lg-3 row  d-flex justify-content-center align-items-center">
                                                    <div class="col">
                                                        <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                            <input class="form-check-input" type="radio" name="exposure" value="" checked id="isNExposure"/>
                                                            <label class="form-check-label form-label fw-bolder text-dark col-lg-12 pt-3" for="isNExposure">
                                                                N
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                            <input class="form-check-input" type="radio" name="exposure" value="" checked id="isYExposure"/>
                                                            <label class="form-check-label form-label fw-bolder text-dark col-lg-12 pt-3" for="isYExposure">
                                                                Y
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                <label class="col-lg-10 form-label fw-bolder text-dark pt-3">노출순서</label>
                                            </div>
                                            <div class="col-lg-4">
