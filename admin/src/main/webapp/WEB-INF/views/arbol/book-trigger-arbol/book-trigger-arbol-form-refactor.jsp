                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-12 row">
                                                ...
                                                <div class="col-lg-3 fv-row d-flex justify-content-center align-items-center" id="fieldSelect2">
                                                    <select
                                                            id="field"
                                                ...
                                                <div class="col-lg-1 d-flex align-items-center justify-content-center">
                                                    <label class="col-lg-12 form-label fw-bolder text-dark pt-3 required">시리즈</label>
                                                </div>
                                                    ...
                                                    <div class="col-lg-3 row">
                                                        <div class="col">
                                                            <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                                <input class="form-check-input" type="radio" name="preview" value="URL" ${not empty list.previewUrl || empty list ? 'checked' : ''} id="urlPath" onclick="showPdf()"/>
                                                        ...
                                                        <div class="col">
                                                            <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                                <input class="form-check-input" type="radio" name="preview" value="PDF" ${list.previewUrl eq '' or empty list.previewUrl ? 'checked' : ''} id="isPdf" onclick="showPdf()"/>
                                        ...
                                        <div class="col-lg-12 row emptyUid">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="col-lg-3 row">
                                                    <div class="col">
                                                        <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                            <input class="form-check-input" type="radio" name="isUse" value="N" ${list.isUse eq 'N' || empty list ? 'checked' : ''} id="isN" onclick="changeIntroRadio(this)"/>
                                        ...
                                        <div class="col-lg-12 row">
                                            ...
                                            <div class="col-lg-11 row">
                                                ...
                                                <div class="col-lg-5 row fv-row flex-column">
                                                    <input type="text" class="form-control onlineInput1"       autocomplete="off" name="onlineBookStore" data-idx="1" placeholder="온라인 서점 URL 입력" value="${list.onlineStoreDataList[0].storeUrl}" oninput="validateOnlineStore()"/>
                                                    <div class="base-input__error"></div>
                                                </div>
                                                    ...
                                                    <div class="row mb-8" id="onlineStoreLine${status.index + 1}">
                                                        <div class="col-lg-12 row">
                                                            ...
                                                            <div class="col-lg-11 row">
                                                                ...
                                                                <div class="col-lg-5 row fv-row flex-column">
                                                                    <input       autocomplete="off" type="text" class="form-control onlineInput${status.index}" placeholder="온라인 서점 URL 입력" data-idx="${status.index}" name="onlineBookStore" value="${online.storeUrl}" oninput="validateOnlineStore()" />
                                                                    <div class="base-input__error"></div>
                                                                </div>
                                                                <div class="col-lg-2 d-flex justify-content-center align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-12">
                                            <div class="col-lg-12 row">
                                                <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                    <label class="col-lg-12 form-label fw-bolder text-dark pt-3 required">소개</label>
                                                </div>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                                    <input
                                                                            ...
                                                                            type="radio"
                                                                            name="isSeries"
                                                                            value="N" ${list.isSeries eq 'N' || empty list ? 'checked' : ''}
                                                                            id="isSeriesN"
                                        ...
                                        <div class="row" id="saveButton">
                                            ...
                                            <c:if test="${not empty param.uid}">
                                                <div class="col-12 d-flex justify-content-end">
                                                    <a type="button" id="cancelBtn" data-isAwards="${list.isAwards}" class="btn btn-light-warning me-2" style="background-color: #fff3cd; color: #181C32" href="/arbol/arbol/${list.uid}">
                                                        취소
                                                    </a>
                                                    <button
                                                            data-uid="${list.uid}"
...
<script type="text/javascript">
    ...
    async function fileFormData(uid) {
        ...
        for (let i = 0; i < dropzones.length; i++) {
            ...
            if (dropzoneElement.style.display === 'block') {
                await inputDeleteData(fileSettings[settingKey], fileData, i);
                continue;
            }
    ...
    // 파일 삭제 데이터 추가 file 은 안넣어도 됨 복합키 생성하기 위함
    async function inputDeleteData(settings, fileData, index) {
        fileData.append('files', new Blob());
        fileData.append('sortOrder', index.toString());
        fileData.append('ParentTable', 'ARBOL');
    ...
    async function processFile(file, settings, fileData, sortOrder) {
        ...
        const roundedFileSizeMB = Math.floor(fileSizeMB);
        console.log(settings);
        if (roundedFileSizeMB <= settings.maxSizeMB && settings.allowedExtensions.test(file.name)) {
    ...
    function monitorDropzoneFiles(introNum) {
        if (isSubmitCheck) {
            if (intervalId) {
    ...
    function validateOnlineStore() {
        if (isSubmitCheck) {
            ...
            console.log('onlineStore ===================', checkBool)
            return checkBool;
        }
    }
    ...
    function validateThumbnail() {
        ...
        const dropzone = ntdrop[0].files;
        const dropzoneId = document.getElementById('validdz0');
        clearError('thumbnailFile');

        const dropzoneContainer = document.getElementById('dz0Container').querySelector('.fv-plugins-message-container.invalid-feedback.file_error');

        if (dropzoneId && !dropzoneContainer && subCheck) {   // 한번 생성됨 -> x 누르면 dropzoneId 없어짐
            clearError('thumbnailFile');
            const fileName = dropzoneId.textContent.trim();
            console.log('filename =====', fileName);
            if (fileName === '') {
                showError('thumbnailFile', 'thumbnailFileError', '* 도서 섬네일을 등록해주세요.');
                return false;
            } else if (dropzone[dropzone.length - 1]) {
                const file = dropzone[dropzone.length - 1];
                const fileType = file.type;
                const fileSizeMB = file.size / (1024 * 1024);
                const roundedFileSize = Math.floor(fileSizeMB);
                if ((fileType !== 'image/jpeg' && fileType !== 'image/png' && fileType !== 'image/jpg') || (fileSizeMB > 1)) {
                    showError('thumbnailFile', 'thumbnailFileError', '* 파일용량 및 이미지 파일 유형을 다시 확인해주세요.');
                    return false;
                }
            }
        } else if (!dropzoneContainer && subCheck) {        // 한번도 생성 안됨 || 파일이 지워졌을 경우
            if (!dropzoneId) {
                showError('thumbnailFile', 'thumbnailFileError', '* 도서 섬네일을 등록해주세요.');
                return false;
    ...
    function validatePdf() {
        const dropzone = ntdrop[1].files;
        const preview = document.querySelector('input[name="preview"]:checked').value;
        const dropzoneId = document.getElementById('validdz1');
        const dropzoneContainer = document.getElementById('dz1Container').querySelector('.fv-plugins-message-container.invalid-feedback.file_error');
        clearError('pdf');

        if (preview === 'PDF') {
            if (dropzoneId && !dropzoneContainer && subCheck2) {
                clearError('pdf');
                const fileName = dropzoneId.textContent.trim();
                if (fileName === '') {
                    showError('pdf', 'pdfError', '* 미리보기 pdf 파일을 등록해주세요.');
                    return false;
                } else if (dropzone[dropzone.length - 1]) {
                    const file = dropzone[dropzone.length - 1];
                    const fileType = file.type;
                    const fileSizeMB = file.size / (1024 * 1024);
                    if ((fileType !== 'application/pdf') || (fileSizeMB > 300)) {
                        showError('pdf', 'pdfError', '* 파일용량 및 이미지 파일 유형을 다시 확인해주세요.');
                        return false;
                    }
                }
            } else if (!dropzoneContainer && subCheck2){
                if (!dropzoneId) {
                    showError('pdf', 'pdfError', '* 미리보기 pdf 파일을 등록해주세요.');
                    return false;
                } else if (dropzone.length === 0) {
    ...
    async function save() {
        ...
        let introNum = '';
        try {
            const response = await fetch('/api/v1/book-trigger-registration/intro/ARBOL' , {
                method: 'GET',
                headers: {
        ...
        if (!isValid || status === 'Invalid'|| (introNum >= 20 && value === 'Y')) {

            document.getElementById('loadingBar').style.display = 'none';
            monitorDropzoneFiles(introNum);
            isSubmitting = false;
            windowUpScroll();
            return;
        }
        ...
        if (isIntro === 'Y') {
            ...
            try {
                const response = await fetch('/api/v1/book-trigger-registration/intro-order/ARBOL?sortOrder=' + introSortOrder, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    }
    ...
    async function postApi() {
        const uid = getRandomAlphanumeric(16);
        ...
        let fileData = await fileFormData(uid);
        if (!fileData) {
            isSubmitting = false;
            document.getElementById('loadingBar').style.display = 'none';
            return;
        ...
        try {
            const response = await fetch('/api/v1/arbol-registration', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (result.result === false) {
                ...
                if (fileData !== null && fileData.has("files")) {

                    const response2 = await fetch('/api/v1/file/file-upload', {
                        method: 'POST',
                        body: fileData
                    });
        ...
        let htmlContent = `
            <div id="isAwardsLine` + awardCnt + `" class="row mb-8 awardLine">
                <div class="col-lg-12 row">
                    ...
                    <div class="col-lg-9 row fv-row flex-column">
                        <input       autocomplete="off" type="text" class="form-control awards" name="award" maxlength="100" placeholder="수상 및 선정 사례 입력 (최대 100자까지 입력가능)" oninput="validateAwardInput()"/>
                        <div class="base-input__error"></div>
                    </div>
                    <div class="col-lg-2 d-flex justify-content-center align-items-center">
                ...
                <div class="col-lg-12 row">
                    ...
                    <div class="col-lg-11 row">
                        ...
                        <div class="col-lg-5 row flex-column">
                            <input       autocomplete="off" type="text" class="form-control onlineInput` + itemCnt + `" data-idx="`+ itemCnt + `" name="onlineBookStore" placeholder="온라인 서점 URL 입력" oninput="validateOnlineStore()" />
                           <div class="base-input__error"></div>
                        </div>
                       <div class="col-lg-2 d-flex justify-content-center align-items-center">
    ...
    let seriesCnt = 0;
    async function plusSeriesLine(seriesBookName) {
        console.log(seriesBookName.bookName);
        if (seriesCnt >= 10) {
        ...
        row.id = "isSeriesLine" + seriesCnt; // 각 행에 고유 ID 할당
        row.dataset.index = seriesBookName.index;
        row.dataset.uid = seriesBookName.uid;
        row.dataset.bookName = seriesBookName.bookName;
        const cellNumber = row.insertCell(0);
        const cellBookName = row.insertCell(1);
        const cellAction = row.insertCell(2);

        cellNumber.textContent = num + '.';
        cellBookName.textContent = seriesBookName.bookName;
        cellAction.innerHTML = `<button type="button" data-idx="` + seriesCnt + `" class="btn btn-secondary seriesBtn" onclick="deleteSeries(this)">삭제 -</button>`;
    ...
    //     container.remove();
    //     seriesCnt--;
    //     seriesBookList = seriesBookList.filter(item => item.index !== idx);
    //     console.log(seriesBookList);
    //
    //     const lines = document.querySelectorAll('.seriesLine');
    //     lines.forEach((line, index) => {
    //         const newIndex = index + 1;
    //         line.id = 'isSeriesLine' + newIndex;
    //
    //         const button = line.querySelector(`button[onclick="deleteSeries(this)"]`);
    //         if (button) {
    //             button.setAttribute('data-idx', newIndex);
    //         }
    //
    //         const label = line.querySelector('label.seriesNumber');
    //         if (label) {
    //             label.textContent = "0" + newIndex + ".";
    //         }
    //     });
    //
    //     let seriesLen = document.querySelectorAll('.seriesLine').length;
    //     if (seriesLen === 3) {
    //         const btn = document.querySelectorAll('.seriesBtn');
    //         btn.forEach((btn) => {
    //             btn.setAttribute('disabled', 'disabled');
    //         });
    //     }
    ...
    function deleteSeries(element) {
        if (seriesCnt <= 0) {
            return; // 아무런 시리즈가 추가되지 않았을 때는 아무 동작도 하지 않습니다.
        }

        console.log(seriesBookList)

        const idx = parseInt(element.getAttribute('data-idx')); // 클릭된 버튼에서 인덱스를 가져옵니다.
        const index = parseInt(element.getAttribute('data-index'));
        let container = document.getElementById('isSeriesLine' + idx); // 해당 인덱스를 가진 행을 가져옵니다.
        if (container) {
            container.remove(); // 해당 행을 삭제합니다.
            seriesCnt--; // 전역 시리즈 카운터를 감소시킵니다.
            console.log('idx====', idx, 'index====', index);
            console.log(seriesBookList)
            seriesBookList = seriesBookList.filter(item => item.index !== index.toString()); // 시리즈 목록에서 해당 요소 제거
            console.log(seriesBookList.length)

            // 모든 남은 시리즈 라인의 ID와 버튼의 data-idx를 업데이트합니다.
            ...
            lines.forEach((line, index) => {
                ...
                if (label) {
                    label.textContent = (newIndex < 10 ? "0" : "") + newIndex + "."; // 라벨 번호 업데이트
                }
            });
            // 시리즈가 3개 이하일 경우 모든 삭제 버튼을 비활성화하고, 그렇지 않으면 활성화
            updateDeleteButtonState();
        } else {
            console.error('Failed to find the series line to delete:', 'isSeriesLine' + idx);
        }
    }
    ...
    async function update(element) {
        ...
        let introNum = '';
        try {
            const response = await fetch('/api/v1/arbol-registration/intro/BOOK-TRIGGER?uid=' + uid , {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
        ...
        console.log('introNum = ===', introNum, 'value ===',value, 'isValid ===', isValid, 'status ===', status);
        if (!isValid || status === 'Invalid'|| (introNum >= 20 && value === 'Y')) {
            document.getElementById('loadingBar').style.display = 'none';
        ...
        if (isIntro === 'Y') {
            introSortOrder = document.getElementById('introOrder').value;
            try {
                const response = await fetch('/api/v1/book-trigger-registration/intro-order/ARBOL?sortOrder=' + introSortOrder + '&uid=' + uid, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    }
    ...
    async function updateApi(element) {
        ...
        try {
            const response = await fetch('/api/v1/arbol-registration/' + uid, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async function searchSeriesBook() {
        ...
        try {
            const response = await fetch('/api/v1/arbol-registration/series-book-list' + queryParams, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
    ...
    function openSeriesModalHandler(event) {
        ...
        let url = '/arbol/arbol-series-search-modal';
        let params = [];
