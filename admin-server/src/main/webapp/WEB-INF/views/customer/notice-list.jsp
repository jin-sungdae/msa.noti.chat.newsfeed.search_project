                        ...
                        <form class="form" id="noticeForm">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        >
                                            <c:forEach items="${noticeKindType}" var="type" varStatus="status">
                                                <option value="<c:out value='${type}'/>" <c:if test="${type.getName() == search.noticeKind.getName()}">selected</c:if> >
                                                    <c:choose>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/customer/notice" class="btn btn-light" style="color: #181c32; background-color : #fff3cd">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0 table-responsive">
                                    ...
                                    <c:forEach items="${noticeList}" var="list" varStatus="status">
                                        <tr>
                                            ...
                                            <td class="text-dark fw-bold">
                                                ...
                                                <c:forEach items="${noticeKindType}" var="type" varStatus="status">
                                                    <c:if test="${fn:contains(list.noticeKind, type.getName()) && type.getValue() != ''}">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/customer/notice-reg-form" class="btn btn-m" style=" color: #fff; background-color: #343a40;">
                                    등록
                                    </a>
                                </div>
                            </div>
...
//        }
    ...
    const changePerPage = (select) => {
        ...
        document.querySelector('form > input[name="perPage"]').value = perPage;
    ...
    const loadView = (element) => {
        ...
        let noticeKind = document.getElementById('noticeKind').value;
        let isOpen = document.getElementById('isOpen').value;
        let searchValue = document.getElementById('searchValue').value;
        let page = document.getElementById('page').value;
        let perPage = document.getElementById('perPage').value;
        const uid = element.getAttribute('data-uid');
        const url = '/customer/notice/' + uid + '?page=' + page + '&perPage='+ perPage+ '&startDate='+ startDate +'&endDate='+ endDate +'&noticeKind='+ noticeKind +'&isOpen='+ isOpen +'&searchValue='+ searchValue;
