                    ...
                    <div class="card mb-7">
                            <div class="card-body">
                                ...
                                <div class="row g-8">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        >
                                            <option></option>
                                            <option value='POST' ${param.actionType eq 'POST' ? 'selected' : ''}>등록</option>
                                            <option value='GET' ${param.actionType eq 'GET' ? 'selected' : ''}>조회</option>
                                            <option value='PUT'   ${param.actionType eq 'PUT' || param.actionType eq 'PATCH' ? 'selected' : ''}>수정</option>
                                            <option value='DOWNLOAD' ${param.actionType eq 'DOWNLOAD' ? 'selected' : ''}>다운로드</option>
                                        </select>
                                    </div>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/log/usage-log" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
                                ...
                                <c:if test="${not empty list}">
                                    <c:forEach items="${list}" var="list" varStatus="status">
                                        <tr>
                                            ...
                                            <td class="text-dark fw-bold text-hover-warning hoverable" data-uid="${list.uid}">
                                                <c:out value="${list.detail}"/>
                                            </td>
                                            <td class="text-dark text-hover-warning fw-bold hoverable" data-uid="${list.uid}">
                                                <c:out value="${list.actionType}"/>
                                            </td>
                                            <td class="text-dark text-hover-warning fw-bold hoverable" data-uid="${list.uid}">
                                                <c:choose>
                                                    <c:when test="${list.actionType eq 'DOWNLOAD'}"><c:out value="1"/></c:when>
