                        ...
                        <form>
                            <div class="card mb-5 mb-xl-10">
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-lg-6 row">
                                                ...
                                                <div class="col-lg-9 row">
                                                    <div class="col-lg-8 form-label text-dark pt-3">
                                                        <label class="form-label text-dark pt-3">
                                    ...
                                    <div class="row mb-8" id="passwordChangeView">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-6 row">
                                                <div class="col-lg-3 d-flex align-items-center">
                                                ...
                                                <div class="col-lg-9 row">
                                                    <div class="col-lg-4 form-label text-dark pt-3">
                                                            <button type="button" class="btn btn-dark" style=" color: #fff; background-color: #343a40;" onclick="changePasswordView()">비밀번호 변경</button>

                                                    </div>

                                                    <div class="col-lg-8 form-label text-dark pt-3 d-flex align-items-center">
                                                        <span class="ms-2 form-label fw-bold text-gray-600">* 비밀번호를 변경할 경우에만 이용하세요.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-6" id="passwordView" style="display: none;">
                                        <div class="col-lg-12 row">
...
<script type="text/javascript">
    ...
    const validForm = async (type) => {
        ...
        return adminNameBol && phoneNoBol
    ...
    const modify = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/v1/account/' + uid, {
                method: 'PUT',
                headers: {
    ...
    function changePasswordView() {
        ...
        if (passwordView.style.display === 'none') {
            passwordChangeView.style.display = 'none';
