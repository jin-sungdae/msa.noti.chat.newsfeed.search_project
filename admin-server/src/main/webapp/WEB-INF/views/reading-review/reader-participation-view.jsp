                                    ...
                                    <c:if test="${(readerParticipationBoard != null) and ((articleYN eq 'Y') or (contextYN eq 'Y') or (readerParticipationBoard.isBoard eq 'Y'))}">
                                        <div class="card-toolbar">
                                            <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0">
                                                <li class="nav-item">
                                                    <a class="nav-link fw-bolder text-dark detailTab active" data-bs-toggle="tab" data-page-type="detail" style="cursor: pointer">상세정보</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link fw-bolder detailTab text-dark" data-bs-toggle="tab" data-page-type="participation" style="cursor: pointer">참여현황</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </c:if>
                                    ...
                                    <div class="row mb-8">
                                        <div class="row mb-8">
                                            <div class="col-lg-6 row">
                                                <div class="col-lg-2 d-flex justify-content-center align-items-center">
                                                    <label class="col-lg-11 form-label fw-bolder text-dark pt-3">작성자</label>
                                                </div>
                                                <div class="col-lg-10">
                                                    <div class="col-lg-12 form-label text-dark pt-3">
                                                        <c:out value="${readerParticipationBoard.isBoard eq 'Y'? (readerParticipationBoard.userName += '(' += readerParticipationBoard.userId += ')') :readerParticipationBoard.adminBoard}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 row">
                                        ...
                                        <div class="row mb-8">
                                            <div class="col-lg-12 row">
                                                <div class="col-lg-12 row">
                                                    <div class="col-lg-1 d-flex align-items-center justify-content-center">
                                                        <label class="col-lg-12 form-label fw-bolder text-dark pt-3 validate">제목</label>
                                                    </div>
                                                    <div class="col-lg-10">
                                                        <div class="col-lg-12 form-label text-dark pt-3">
                                        ...
                                        <c:if test="${contextYN eq 'Y'}">
                                            <c:if test="${readerParticipationBoard.isPeriod eq 'Y'}">
                                                <div class="row mb-8">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center ">
                                                            <label class="col-lg-12 form-label fw-bolder text-dark pt-3">노출기간</label>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <div class="col-lg-12 form-label text-dark pt-3">
                                        ...
                                        <c:if test="${(noticeYN eq 'Y') or (contextYN eq 'Y') or (readerParticipationBoard.isBoard eq 'Y')}">
                                            <div class="row mb-8">
                                                <div class="col-lg-12 row">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex align-items-center justify-content-center">
                                                            <label class="col-lg-12 form-label fw-bolder text-dark pt-3"><c:out value="${noticeYN ne 'Y'? '상세': ''}"/>내용</label>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <div class="col-lg-12 form-label text-dark pt-3">
                                        ...
                                        <c:if test="${articleYN eq 'Y'}">
                                            <div class="row mb-8">
                                                <div class="col-lg-12 row">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center ">
                                                            <label class="col-lg-12 form-label fw-bolder text-dark pt-3">발행월호</label>
                                                        </div>
                                                        <div class="col-lg-6 row">
                                                            <div class="col-lg-6">
                                                                <div class="col-lg-12 form-label text-dark pt-3">
                                                        ...
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center ">
                                                            <label class="col-lg-10 form-label fw-bolder text-dark pt-3">투표 선택 수</label>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="col-lg-12 form-label text-dark pt-3">
                                            ...
                                            <div class="row mb-8">
                                                <div class="col-lg-12 row">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex align-items-center justify-content-center">
                                                            <label class="col-lg-12 form-label fw-bolder text-dark pt-3 validate">투표 목록</label>
                                                        </div>
                                                        <div class="col-lg-10">
                                                ...
                                                <div class="col-lg-11 pt-3 row">
                                                    <div class="col-lg-12">
                                                        <label class="form-check-label me-10">
                                                            <span><c:out value="${readerParticipationBoard.isOpen eq 'N'? 'N':'Y'}"/></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-8">
                                                <div class="col-lg-12 row">
                                                    ...
                                                    <div class="fv-row fv-plugins-icon-container col-lg-11">
                                                        <div class="col-lg-12 row">
                                                            <c:choose>
                                                                <c:when test="${readerParticipationBoard.fileList[0] ne null}">
                                                                    <c:forEach var="fileList" items="${readerParticipationBoard.fileList}">
                                                                        <!-- 이미지 -->
                                                                        <a href="<c:out value="${fileList.fileUrl}"/>" download>
                                                                            <img src="<c:out value="${fileList.fileUrl}"/>" style="width: 25%; height: auto;"/>
                                                                        </a>
                                                                    </c:forEach>
                                                                </c:when>
                                                                <c:otherwise>
                                ...
                                <div class="card-footer" id="footerIdx">
                                    <div class="row">
                                        <div id="listGroup" class="col-3">
                                            <a href="/reading-review/reader-participation/${school}?pageNo=${pageNo}&startDate=${startDate}&endDate=${endDate}&categoryIndex=${categoryIndex}&searchValue=${searchValue}" class="btn btn-light-primary" style="background-color: #343a40; color: #FFFFFF">목록</A>
                                        </div>
                                        <div id="saveGroup" class="col-9 d-flex justify-content-end">
                                            <c:choose>
                                                <c:when test="${readerParticipationBoard.isBoard eq 'N'}">
                                                    <button type="button" id="cancelBtn" class="btn btn-light-primary me-2" style="background-color: #fff3cd; color: #181C32" onclick="deleteParticipation()" <c:out value="${readerParticipationBoard.isOpen eq 'Y'? 'disabled' : ''}"/>>
                                                        삭제
                                                    </button>
                                                    <button
                                                            type="button"
                        ...
                        try {
                            ...
                            if (result.resultCode == 'SUCCESS') {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        location.href = '/reading-review/reader-participation/' + school + '/' + uid;
                                    }
                                })
                            }
                        } catch (Exception) {
