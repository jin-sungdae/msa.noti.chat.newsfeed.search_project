                    ...
                    <div class="card mb-7">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                                <li class="nav-item">
                                    <a class="nav-link tab_navi active fw-bolder text-dark" id="tab_krContent" data-bs-toggle="tab" href="#nt_krContent">국어</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tab_navi fw-bolder text-dark" id="tab_enContent" data-bs-toggle="tab" href="#nt_enContent">영어</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tab_navi fw-bolder text-dark" id="tab_mathContent" data-bs-toggle="tab" href="#nt_mathContent">수학</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tab_navi fw-bolder text-dark" id="tab_societyContent" data-bs-toggle="tab" href="#nt_societyContent">사회</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tab_navi fw-bolder text-dark" id="tab_scienceContent" data-bs-toggle="tab" href="#nt_scienceContent">과학</a>
                                </li>
                            </ul>

                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane tab_navi_content fade show active" id="nt_krContent" role="tabpanel">
                                ...
                                <div class="tab-pane tab_navi_content  fade" id="nt_enContent" role="tabpanel">
                                    <div class="view" style="display: ${empty list ? '' : 'none'}">
                                       <textarea class="form-control form-control-solid contents"
                                                 type="text"
                                                 rows="5"
                                ...
                                <div class="tab-pane tab_navi_content  fade" id="nt_mathContent" role="tabpanel">
                                    <div class="view" style="display: ${empty list ? '' : 'none'}">
                                        <textarea class="form-control form-control-solid contents"
                                                  type="text"
                                                  rows="5"
                                ...
                                <div class="tab-pane tab_navi_content  fade" id="nt_societyContent" role="tabpanel">
                                    <div class="view" style="display: ${empty list ? '' : 'none'}">
                                       <textarea class="form-control form-control-solid contents"
                                                 type="text"
                                                 rows="5"
                                ...
                                <div class="tab-pane tab_navi_content  fade" id="nt_scienceContent" role="tabpanel">
                                    <div class="view" style="display: ${empty list ? '' : 'none'}">
                                        <textarea class="form-control form-control-solid contents"
                                                  type="text"
                                                  rows="5"
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const tabContentId = new URLSearchParams(window.location.search).get('tabContentId');
        console.log(tabContentId);

        if (tabContentId) {
            const tabNavi = 'tab_' + tabContentId;

            document.querySelectorAll('.tab_navi').forEach(tab => {
                tab.classList.remove('active');
            });

            document.querySelectorAll('.tab_navi_content').forEach(tab => {
                tab.classList.remove('active');
                tab.classList.remove('show');
            });

            document.getElementById(tabNavi).classList.add('active');


            const activeTab = document.getElementById('nt_' + tabContentId);
            ...
            if (result.result === false) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        location.href = '/reference-book/guide?tabContentId=' + tabContentId;
                    }
                })
