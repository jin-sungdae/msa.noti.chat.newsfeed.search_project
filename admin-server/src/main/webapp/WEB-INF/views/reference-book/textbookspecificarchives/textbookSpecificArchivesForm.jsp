                            ...
                            <div class="card mb-5 mb-xl-10">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1  d-flex align-items-center justify-content-center">
                                                <label class="col-lg-12 form-label fw-bolder text-dark pt-3 required">과목</label>
                                            </div>
                                            <div class="col-lg-10 row">
                                                <div class="col-lg-3">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="01" ${data.userDetail.teacherCertificationStatus eq '미완료' ? 'selected' : ''}>미완료</option>
                                                        <option value="02" ${data.userDetail.teacherCertificationStatus eq '대기' ? 'selected' : ''}>대기</option>
                                                        <option value="05" ${data.userDetail.teacherCertificationStatus eq '검토' ? 'selected' : ''}>검토</option>
                                                        <option value="03" ${data.userDetail.teacherCertificationStatus eq '완료' ? 'selected' : ''}>완료</option>
                                                        <option value="04" ${data.userDetail.teacherCertificationStatus eq '반려' ? 'selected' : ''}>반려</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1  d-flex align-items-center justify-content-center">
                                                <label class="col-lg-12 form-label fw-bolder text-dark pt-3 required">자료구분</label>
                                            </div>
                                            <div class="col-lg-10">
                                                <div class="col-lg-12 form-label text-dark pt-3">
                                                    <div class="col-lg-4">
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1  d-flex align-items-center justify-content-center">
                                                <label class="col-lg-12 form-label fw-bolder text-dark pt-3 required">자료명</label>
                                            </div>
                                            <div class="col-lg-10">
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container  pt-3">
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            ...
                                            <div class="col-lg-10">
                                                    ...
                                                    <div class="col-lg-2 row">
                                                        <div class="col">
                                                            <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                                <input class="form-check-input" type="radio" name="preview" value="" checked id="isUSE"/>
                                                        ...
                                                        <div class="col">
                                                            <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                                <input class="form-check-input" type="radio" name="preview" value="" checked id="isPDF"/>
                                                ...
                                                <div class="row">
                                                    <div id="url" class="col-lg-12 form-label text-dark">
                                                        <input type="text"  class="form-control" placeholder="URL 경로 입력" id="userName" name="userName" value="${data.user.userName}" required>
                                                    </div>
                                                    <div id="pdf" class="col-lg-12 form-label text-dark" style="display: none;">
                                                        <jsp:include page="/FileFormINC" flush="false">
                                                            <jsp:param name="isImage" value="false" />
                                                            <jsp:param name="hasOrder" value="false" />
                                                            <jsp:param name="parentTable" value="banner"/>
                                        ...
                                        <div class="col-lg-12 row">
                                            ...
                                            <div class="col-lg-7 row">
                                                <div class="col-lg-2 row">
                                                    <div class="col">
                                                        <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                            <input class="form-check-input" type="radio" name="intro" value="" checked id="isIntroN"/>
                                                    ...
                                                    <div class="col">
                                                        <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                            <input class="form-check-input" type="radio" name="intro" value="" checked id="isIntroY"/>
