                                        ...
                                        <div class="col-lg-12 row">
                                            ...
                                            <div class="col-lg-11 row">
                                                ...
                                                <div class="col-lg-5 row fv-row flex-column">
                                                    <input type="text" class="form-control onlineInput1"  maxlength="500"     autocomplete="off" name="onlineBookStore" data-idx="1" placeholder="온라인 서점 URL 입력" value="${list.onlineStoreDataList[0].storeUrl}" oninput="validateOnlineStore()"/>
                                                    <div class="base-input__error"></div>
                                                </div>
                                                    ...
                                                    <div class="row mb-8" id="onlineStoreLine${status.index + 1}">
                                                        <div class="col-lg-12 row">
                                                            ...
                                                            <div class="col-lg-11 row">
                                                                ...
                                                                <div class="col-lg-5 row fv-row flex-column">
                                                                    <input       autocomplete="off" type="text" maxlength="500" class="form-control onlineInput${status.index}" placeholder="온라인 서점 URL 입력" data-idx="${status.index}" name="onlineBookStore" value="${online.storeUrl}" oninput="validateOnlineStore()" />
                                                                    <div class="base-input__error"></div>
                                                                </div>
                                                                <div class="col-lg-2 d-flex justify-content-center align-items-center">
                ...
                <div class="col-lg-12 row">
                    ...
                    <div class="col-lg-11 row">
                        ...
                        <div class="col-lg-5 row flex-column">
                            <input   maxlength="500"    autocomplete="off" type="text" class="form-control onlineInput` + itemCnt + `" data-idx="`+ itemCnt + `" name="onlineBookStore" placeholder="온라인 서점 URL 입력" oninput="validateOnlineStore()" />
                           <div class="base-input__error"></div>
                        </div>
                       <div class="col-lg-2 d-flex justify-content-center align-items-center">
