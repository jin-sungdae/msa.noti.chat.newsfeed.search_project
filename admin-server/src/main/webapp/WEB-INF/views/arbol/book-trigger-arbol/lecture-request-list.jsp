                        ...
                        <form class="form">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/arbol/lecture-request" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
...
<script type="text/javascript">
    ...
    function openLectureRequestForm(element) {
        ...
        const url = '/arbol/lecture-request/' + uid;
    ...
    function fetchUserList(page) {
        ...
        location.href = '/arbol/lecture-request' + queryParams;
    }
