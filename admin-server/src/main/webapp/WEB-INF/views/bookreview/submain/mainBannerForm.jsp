                                    ...
                                    <div class="row mb-8" id="floatingBanner">
                                        ...
                                        <div class="col-lg-11">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 row">
                                                    <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                        <label class="col-lg-10 form-label fw-bolder text-dark required">PC</label>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 row">
                                                    <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                        <label class="col-lg-10 form-label fw-bolder text-dark required">Mobile</label>
                                                    </div>
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            ...
                                            <div class="col-lg-2 row">
                                                <div class="col">
                                                    <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                        <input class="form-check-input" type="radio" name="isUse" value="" checked id="isN"/>
                                                ...
                                                <div class="col">
                                                    <div class="form-check form-check-custom form-check-warning form-check-solid">
                                                        <input class="form-check-input" type="radio" name="isUse" value="" checked id="isY"/>
                                            ...
                                            <div class="col-lg-4 pt-3">
                                                <span class="ms-2" style="color: gray;">* 노출여부 설정은 1개만 등록 가능합니다.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-5 mb-xl-10">
                                ...
                                <div class="card-body">
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                <label class="col-lg-10 form-label fw-bolder text-dark pt-3">동영상 URL</label>
                                            </div>
                                            <div class="col-lg-10 row">
                                                <input type="text" class="form-control">
                                            </div>
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                <label class="col-lg-10 form-label fw-bolder text-dark pt-3 required">인터뷰 이미지</label>
                                            </div>
                                    ...
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                <label class="col-lg-10  form-label fw-bolder text-dark pt-3">학습자료<br>(학생용)</label>
                                            </div>
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <div class="row mb-8">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                            <label class="col-lg-10 d-flex justify-content-center align-items-center form-label fw-bolder text-dark required">Q.</label>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <input type="text" class="form-control">
                                                        </div>
                                                ...
                                                <div class="row mb-8">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                            <label class="col-lg-10 d-flex justify-content-center align-items-center form-label fw-bolder text-dark required">A.</label>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <input type="text" class="form-control">
                                                        </div>
                            ...
                            <div class="card mb-5 mb-xl-10">
                                ...
                                <div class="card-body">
                                    <div class="row mb-8">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                <label class="col-lg-10 form-label fw-bolder text-dark pt-3 required">후기 배너</label>
                                            </div>
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                            <label class="col-lg-10 d-flex justify-content-center align-items-center form-label fw-bolder text-dark required">1.</label>
                                                        </div>

                                                        <div class="col-lg-10 row" id="dropzoneContainer">
                                                            <!-- 파일 업로드 섹션 -->
                                                            ...
                                                            <div class="col-lg-7 d-flex justify-content-center align-items-center">
                                                                <input type="text" class="form-control" placeholder="링크 URL">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                            <label class="col-lg-10 d-flex justify-content-center align-items-center form-label fw-bolder text-dark required">2.</label>
                                                        </div>
                                                        <div class="col-lg-10 row" id="dropzoneContainer">
                                                            <!-- 파일 업로드 섹션 -->
                                                            <div class="col-lg-5 row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                            <label class="col-lg-10 d-flex justify-content-center align-items-center form-label fw-bolder text-dark required">3.</label>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 row">
                                                        <div class="col-lg-1 d-flex justify-content-center align-items-center">
                                                            <label class="col-lg-10 d-flex justify-content-center align-items-center form-label fw-bolder text-dark required">4.</label>
                                                        </div>
