                        ...
                        <form class="form">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/textbook/main-baaner-list" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
                   ...
                   <%@ include file="/WEB-INF/views/common/SelectPaging.jsp" %>
                        ...
                        <div class="card-body pt-0 table-responsive">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/book-review/main-banner-form" class="btn btn-m" style=" color: #fff; background-color: #343a40;">
                                        등록
                                    </a>
                                </div>
                            </div>
