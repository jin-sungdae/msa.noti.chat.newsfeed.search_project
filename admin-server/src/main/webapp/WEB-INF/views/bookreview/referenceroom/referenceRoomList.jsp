                        ...
                        <form class="form">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                >
                                                    <option></option>
                                                    <option value='지학사' ${param.joinRoot eq '지학사' ? 'selected' : ''}>첫걸음독서평설</option>
                                                    <option value='네이버' ${param.joinRoot eq '네이버' ? 'selected' : ''}>초등독서평설</option>
                                                    <option value='구글'   ${param.joinRoot eq '구글' ? 'selected' : ''}>중학독서평설</option>
                                                    <option value='카카오' ${param.joinRoot eq '카카오' ? 'selected' : ''}>고교독서평설</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-4">
                                                ...
                                                >
                                                    <option></option>
                                                    <option value='지학사' ${param.joinRoot eq '지학사' ? 'selected' : ''}>Y</option>
                                                    <option value='네이버' ${param.joinRoot eq '네이버' ? 'selected' : ''}>N</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-4">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/reference/notice-popup-list" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
                   ...
                   <%@ include file="/WEB-INF/views/common/SelectPaging.jsp" %>
                        ...
                        <div class="card-body pt-0 table-responsive">
                            ...
                            <table class="table table-row-bordered gy-5" id="faqCommonTable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark text-hover-warning fw-bold hoverable"
                                        ...
                                        onclick="openUserForm(this)">
                                        <i class="fas bi-file-earmark-pdf fs-1 me-2"></i>
                                    </td>
                                    <td class="text-dark text-hover-warning fw-bold hoverable"
                                        data-uid="${list.uid}"
                                        name="userId"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/book-review/reference-room-form" class="btn btn-m" style=" color: #fff; background-color: #343a40;">
                                        등록
                                    </a>
                                </div>
                            </div>
