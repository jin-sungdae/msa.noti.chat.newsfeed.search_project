                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                >
                                                    ...
                                                    <c:forEach items="${departmentList}" var="department">
                                                        <option value="<c:out value="${department}"/>" <c:if test="${search.department eq department}">selected</c:if> ><c:out value="${department}"/></option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <div class="col-lg-4">
...
//        }
    ...
    const loadView = (element) => {
        ...
        let adminGroupIndex = document.getElementById('adminGroupIndex').value;
        let searchValue = document.getElementById('searchValue').value;
        let page = document.getElementById('page').value;
        let perPage = document.getElementById('perPage').value;
        const uid = element.getAttribute('data-uid');
        const url = '/site/admin-account/' + uid + '?page=' + page + '&perPage=' + perPage +  '&startDate='+ startDate +'&endDate='+ endDate + '&isUse=' + isUse + '&searchValue=' + searchValue + '&department=' +department + '&adminGroupIndex=' +adminGroupIndex;
