        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div id="kt_content_container" class="container-fluid">
                    <div class="card mb-7">
                        <form class="form" id="visualBannerForm">
                            <input type="hidden" name="visualBannerLocation" value="${bannerLocation}">
                            ...
                            <div class="card-body">
                                <div class="row g-8">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <select
                                                name="isOpen"
                                                class="form-select form-select-solid unselect-form custom-select-box"
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <div>
                                        <a href="/${menu}/visual-banner" class="btn btn-secondary" style="color: #181c32; background-color : #fff3cd">
...
<%--                                                <c:out value="${list.modDate eq null ? list.regDate : list.modDate}"/>--%>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/${menu}/visual-banner-reg-form" class="btn btn-m" style=" color: #fff; background-color: #343a40;">
                                        등록
                                    </a>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function fetchUserList() {
        ...
        document.getElementById('visualBannerForm').submit();
    }
    ...
    function openUserForm(element) {
        ...
        const url = '/${menu}/visual-banner/'+uid + location.search
